<div id='editbox' style='display: none; margin: 10px 20px;'>
    <form class="layui-form  layui-form-pane" lay-filter="processform" onsubmit="return false;">
        ...
        <div class="layui-form-item">
            <label class="layui-form-label" style="width: 160px;"> <em style='color:red;'>*</em> 下单时间 </label>
            <div class="layui-input-inline">
                <input class="layui-input formdate" name="develop_date" lay-verify="required" lay-filter="develop_date">
            </div>
            
            <label class="layui-form-label" style="width: 160px;"> <em style='color:red;'>*</em> 合同签订完结时间 </label>
            <div class="layui-input-inline">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="hidden" name="customer_id" lay-filter="customer_id" >
...
<script>
    layui.use(['form', 'laydate', 'jquery'], function () {
        ...
        var processformrender = function(data){
            var customer_str = '', company_str = '';
            customer_str += data.customer_name ? data.customer_name : '';
            customer_str += data.phone ? data.phone : '';
            company_str += data.company ? data.company : '';
            company_str += data.landline ? data.landline : '';
